...
{
    /** Target RKA QRIS per (kpi, tahun, bulan) — struktur identik dengan rka_edc. */
    public function up(): void
    {
        Schema::create('rka_qris', function (Blueprint $table) {
            ...
            $table->unique(['uker_id', 'kpi', 'tahun', 'bulan'], 'rka_qris_unique');
