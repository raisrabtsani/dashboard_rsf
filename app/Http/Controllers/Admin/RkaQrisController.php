...
use App\Services\RkaQrisCsvImportService;
...
class RkaQrisController extends Controller
{
    public function __construct(private readonly RkaQrisCsvImportService $service) {}

    public function index(): Response
    {
        return Inertia::render('Admin/Rka/Qris', [
            'kolomBerkas' => RkaQrisCsvImportService::KOLOM,
        ]);
    }
