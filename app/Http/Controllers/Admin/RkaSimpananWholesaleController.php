...
use App\Services\RkaSimpananWholesaleCsvImportService;
...
class RkaSimpananWholesaleController extends Controller
{
    public function __construct(private readonly RkaSimpananWholesaleCsvImportService $service) {}

    public function index(): Response
    {
        return Inertia::render('Admin/Rka/SimpananWholesale', [
            'kolomBerkas' => RkaSimpananWholesaleCsvImportService::KOLOM,
        ]);
    }
