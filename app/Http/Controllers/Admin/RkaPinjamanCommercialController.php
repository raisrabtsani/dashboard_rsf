...
use App\Services\RkaPinjamanCommercialCsvImportService;
...
class RkaPinjamanCommercialController extends Controller
{
    public function __construct(private readonly RkaPinjamanCommercialCsvImportService $service) {}

    public function index(): Response
    {
        return Inertia::render('Admin/Rka/PinjamanCommercial', [
            'kolomBerkas' => RkaPinjamanCommercialCsvImportService::KOLOM,
        ]);
    }
