...
use App\Services\RkaLabaCsvImportService;
...
class RkaLabaController extends Controller
{
    public function __construct(private readonly RkaLabaCsvImportService $service) {}

    public function index(): Response
    {
        return Inertia::render('Admin/Rka/Laba', [
            'kolomBerkas' => RkaLabaCsvImportService::KOLOM,
        ]);
    }
