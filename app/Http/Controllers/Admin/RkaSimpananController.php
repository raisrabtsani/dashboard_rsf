...
use App\Services\RkaSimpananCsvImportService;
...
class RkaSimpananController extends Controller
{
    public function __construct(private readonly RkaSimpananCsvImportService $service) {}

    public function index(): Response
    {
        return Inertia::render('Admin/Rka/Simpanan', [
            'kolomBerkas' => RkaSimpananCsvImportService::KOLOM,
        ]);
    }
