...
/**
 * Controller TIPIS — hanya parse request lalu delegasi ke RecoveryService.
 *
...
{
    public function __construct(private readonly RecoveryService $service) {}

    public function index(Request $request): Response
    {
        return Inertia::render('RecoveryDashboard/Index', [
