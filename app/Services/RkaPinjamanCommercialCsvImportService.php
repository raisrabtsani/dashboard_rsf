...
/**
 * Import target RKA Pinjaman Commercial — mengikuti RkaPinjamanCsvImportService.
 */
class RkaPinjamanCommercialCsvImportService
{
    ...
    {
        return RkaPinjamanCommercial::query()
    ...
    {
        return RkaPinjamanCommercial::query()->where('tahun', $tahun)->delete();
    }
