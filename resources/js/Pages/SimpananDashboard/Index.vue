 ...
 * ke backend. Salin pola ini untuk domain berikutnya.
 */
...
const KOLOM = [
    ...
    { key: 'nilai', label: 'Saldo', kelas: 'text-right' },
...
<template>
    <Head title="Dashboard Simpanan (DPK)" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                Dashboard Simpanan (DPK)
            </h2>
        </template>
