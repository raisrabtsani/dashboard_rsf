...
/**
 * Halaman upload data aktual BULANAN — satu komponen untuk domain per (tahun,
 * bulan) seperti Laba. Riwayat, unduh, dan hapus dikunci pada periode.
 */
...
const KOLOM = [
    { key: 'periode', label: 'Periode', kelas: 'text-left' },
    { key: 'jumlah_baris', label: 'Jumlah Baris', kelas: 'text-right' },
    { key: 'total', label: props.labelNilai, kelas: 'text-right' },
...
async function hapusSatuPeriode(r) {
    if (!confirm(`Hapus seluruh data ${props.domain} periode ${r.nama}?`)) return;
            ...
            <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="rounded-lg bg-white p-4 shadow ring-1 ring-gray-100">
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        ...
                        Nilai dalam rupiah penuh. Bulan boleh angka 1-12 atau nama bulan.
                    </p>
                    <p class="mt-1 text-xs text-amber-600">{{ catatan }}</p>
                ...
                <div class="relative rounded-lg bg-white shadow ring-1 ring-gray-100">
                    ...
                    <div class="border-b border-gray-100 p-4">
                        <h3 class="text-sm font-semibold text-gray-700">Riwayat Upload (per Periode)</h3>
                        <p class="mt-1 text-xs text-gray-500">
                        ...
                        <table class="min-w-full divide-y divide-gray-100 text-sm">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                <tr v-for="r in riwayatTerurut" :key="r.periode" class="hover:bg-gray-50">
                                    <td class="px-4 py-2 text-gray-800">{{ r.nama }}</td>
